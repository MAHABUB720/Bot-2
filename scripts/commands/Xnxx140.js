...
"https://i.postimg.cc/rs573S8Q/tumblr-os64hm-Sc-AN1smwom8o10-1280.gif",
   ...
   var mention = Object.keys(event.mentions);
    ...
    if (!mention) return api.sendMessage("আরে বোকাছোদা আগে টেগ দে🥵🤦‍♂️.", threadID, messageID);
   var callback = () => api.sendMessage({body:`${tag}` + ` এই নে লুচ্চা 🥵`,mentions: [{tag: tag,id: Object.keys(event.mentions)[0]}],attachment: fs.createReadStream(__dirname + "/cache/bopmong.gif")}, event.threadID, () => fs.unlinkSync(__dirname + "/cache/bopmong.gif"));  
