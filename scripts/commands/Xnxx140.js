...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  var tl = ["হ্যা বলো আমি শুনছি😌","আমি শুধু আমার বস সুমু কে ভালোবাসি 😺"];
  var rand = tl[Math.floor(Math.random() * tl.length)]
    ...
    if ((event.body.toLowerCase() == "i love u bot") || (event.body.toLowerCase() == "i love you bot")) {
     return api.sendMessage("আমাকে না আমার বস সুমু কে ভালোবাসো😻🥀", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "bot tomar admin ke") || (event.body.toLowerCase() == "আমার এডমিন হলো মাহাবুর")) {
  ...
  if (event.body.indexOf("I Love You") == 0 ||(event.body.indexOf("I love you") == 0 ||          (event.body.indexOf("I love you") == 0 ||                           (event.body.indexOf("i love you") == 0))) {
    var msg = {
      body: `${name}, ${rand}`
    }
