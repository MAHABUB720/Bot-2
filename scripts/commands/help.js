module.exports.config = {
 ...
 version: "2.0.0",
 permssion: 0,
 credits: "Mahabub",//You Can Change The Gif Or Img If You Want Just Put The Link Of Your Gif Or Img To The Var Link
...
const first = numberOfOnePage * page - numberOfOnePage;
    ...
    const siu = `•—»✨𝐌𝐚𝐡𝐚𝐛𝐮𝐛 𝐜𝐡𝐚𝐭 𝐛𝐨𝐭 ✨«—• ${global.config.BOTNAME}\nPage ｢${page}/${Math.ceil(arrayInfo.length/numberOfOnePage)}｣`;
 ...
 const text = `\n•┄┅════❁🌺❁════┅┄•\n\n •—»✨ ${global.config.BOTNAME}\n •—»✨ 𝐌𝐚𝐡𝐚𝐛𝐮𝐛 𝐜𝐡𝐚𝐭 𝐛𝐨𝐭\n\n🌸:Command List: ${arrayInfo.length}\n🌺:Bot Name: ${global.config.BOTNAME}\nPrefix: ${global.config.PREFIX}\n 🌏Owner Facebook Link : https://www.facebook.com/www.xnxx.com140`;
    var link = [
